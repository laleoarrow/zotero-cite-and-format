...
# Word + Zotero Live Citation Repair / Word + Zotero 活体引文修复
...
- a clean **live Zotero source** that can still refresh in Word, or
...
When exporting a static submission file from a live Zotero source, do not treat bibliography fields as generic inline fields.

Use this order:
1. Duplicate the live Zotero source and export on the copy only.
...
For any static submission file derived from a live Zotero source, verify all of the following before claiming success:
...
- the live Zotero version and the static正文版 have no unintended body-text drift
...
- which file is the live Zotero source
